    ...
    <section className="w-full py-8 md:py-12 px-4 md:px-12 lg:px-[114px]">
      <div className="flex flex-col gap-12">
        <div className="max-w-[794px]">
            <h2 className="[font-family:'Helvetica_Neue-Bold',Helvetica] font-bold text-black text-3xl md:text-4xl lg:text-[48px] tracking-[-0.72px] leading-tight mb-4 uppercase">
            Problématique
          </h2>
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
          ...
          <div className="flex flex-col items-start gap-6 md:w-1/2">
            <h2 className="[font-family:'Helvetica_Neue-Bold',Helvetica] font-bold text-black text-3xl md:text-4xl lg:text-[48px] tracking-[-0.72px] leading-tight uppercase">
              Notre réponse
            </h2>
            <p className="[font-family:'Helvetica_Neue-Regular',Helvetica] font-normal text-black text-xl md:text-2xl lg:text-[32px] tracking-[-0.72px] leading-relaxed md:leading-[31px]">
